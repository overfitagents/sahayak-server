    ...
    const state = {
        ...
        timetable: {
            class_6: {
                ...
                Wednesday: [{ subject: 'Science', time: '10:00-11:00' }],
            },
            class_7: {
                Tuesday: [{ subject: 'Science', time: '9:00-10:00' }],
                Thursday: [{ subject: 'Science', time: '11:00-12:00' }],
            },
        },
        year_calendar: {
            term_1: {
    ...
    if (responseData) {
        for (const data of responseData) {
            ...
            if (contentPart) {
                ...
                // else if (contentPart.functionCall || contentPart.functionResponse) {
                //     finalData.push({
                //         data: contentPart.functionCall || contentPart.functionResponse,
                //         type: 'function',
                //         author: data.author
                //     });
                // }
